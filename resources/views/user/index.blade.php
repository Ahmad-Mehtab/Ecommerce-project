...
@section('content')
    ...
    @endif
        ...
        @endif
    <div class="page-hero bg-image overlay-dark" style="background-image: url(./user_assets/img/bg_image_1.jpg);">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 wow fadeInRight" data-wow-delay="400ms">
                        <div class="img-place custom-img-1">
                            <img src="{{ asset('user_assets/img/bg-doctor.png') }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-4 py-2 wow zoomIn">
                    <div class="card-blog">
                        <div class="header">
                            ...
                            <a href="blog-details.html" class="post-thumb">
                                <img src="{{ asset('user_assets/img/blog/blog_2.jpg') }}" alt="">
                            </a>
                        </div>
                        <div class="body">
                            ...
                            <div class="site-info">
                                <div class="avatar mr-2">
                                    <div class="avatar-img">
                                        <img src="{{ asset('user_assets/img/person/person_1.jpg') }}" alt="">
                                    </div>
                                    <span>Roger Adams</span>
                                </div>
                ...
                <div class="col-lg-4 py-2 wow zoomIn">
                    <div class="card-blog">
                        <div class="header">
                            ...
                            <a href="blog-details.html" class="post-thumb">
                                <img src="{{ asset('user_assets/img/blog/blog_3.jpg') }}" alt="">
                            </a>
                        </div>
                        <div class="body">
                            ...
                            <div class="site-info">
                                <div class="avatar mr-2">
                                    <div class="avatar-img">
                                        <img src="{{ asset('user_assets/img/person/person_2.jpg') }}" alt="">
                                    </div>
    ...
    <div class="page-section">
        <div class="container">
            ...
            <form class="main-form" action="{{url('admin/add-appointment')}}" method="POST"> 
              @csrf
                <div class="row mt-5">
                    ...
                    <div class="col-12 col-sm-6 py-2 wow fadeInRight" data-wow-delay="300ms">
                        <select name="selected_dr" id="departement" class="custom-select">
                            <option value="" disabled selected readonly>Select Doctor</option>
                            {{-- @foreach ($doctors_record as $doctor)
    ...
    <div class="page-section banner-home bg-image" style="background-image: url(./user_assets/img/banner-pattern.svg);">
        <div class="container py-5 py-lg-0">
            <div class="row align-items-center">
                ...
                <div class="col-lg-8 wow fadeInRight">
                    ...
                    <a href="#"><img src="{{ asset('user_assets/img/google_play.svg') }}" alt=""></a>
                    <a href="#" class="ml-2"><img src="{{ asset('user_assets/img/app_store.svg') }}"
                            alt=""></a>
                </div>
            </div>
        </div>
