<footer class="page-footer">
    <div class="container">
      ...
      <div class="copy-right " >
        <p id="copyright" style="width: fit-content; margin: auto;">Copyright &copy; 2020 <a href="https://macodeid.com/" target="_blank">MACode ID</a>. All right reserved</p>
      </div>
    </div>
  </footer>
...
<script src="{{asset('user_assets/vendor/owl-carousel/js/owl.carousel.min.js')}}"></script>
