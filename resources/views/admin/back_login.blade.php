...
<head>
    ...
    <link rel="shortcut icon" type="image/jpg" href="{{asset('uv_assets/images/logo.png')}}"/>
...
<body class="bg-deep-dark">
    ...
    <div class="container py-5">
        ...
        <div class="d-flex align-items-center justify-content-center flex-column flex-md-row flex-lg-row">
            {{-- <img src="{{asset('uv_assets/images/logo.png')}}" alt="" style="height: 100px"> --}}
            <h2 class="text-main-color text-center mb-3 font-weight-bold text-uppercase ml-1">Stardom UK</h2>
        </div>
        <div class="row justify-content-center">

            <div class="col-xl-8 col-lg-12 col-md-9">

                <div class="card o-hidden border-0 shadow-lg-dark my-1">
                    <div class="card-body p-0">
                        <!-- Nested Row within Card Body -->
                        <div class="row">
                            {{-- <div class="col-lg-6 d-none d-lg-block bg-login-image" style="background: url({{ asset('admin_assets/img/nexus_login.png') }}); background-size: contain; background-position: center; background-repeat: no-repeat"></div> --}}
                            <div class="col-lg-6 d-lg-block bg-login-image img_res" style="background: url({{ asset('uv_assets/images/logo.png') }}); background-size: 85%; background-color: lightgray;background-repeat: no-repeat;
                            ...
                            <!-- <button class="btn btn-samll bg-dark text-white ">Back to home</button> -->
                                ...
                                <div class="p-5">
                                    ...
                                    @if(session('error'))
                                        ...
                                        <button class="btn btn-basic text-white btn-user btn-block" type="submit" disabled>Login</button>
                                        @else
                                        <button class="btn btn-basic btn-user btn-block" type="submit">Login</button>
                                        @endif
