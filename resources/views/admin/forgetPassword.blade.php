...
<html lang="en">
   <head>
      ...
      <title>@yield('title')RESET PASSWORD | STARDOM UK</title>
      <link
    rel="icon"
    type="image/x-icon"
  ...
  />
   ...
   <body class="bg-deep-dark admin-bg" style="background: #ad1020;">
                     ...
                     <div class="row justify-content-center">
                        <div class="col-md-12">
                           <div class="card border-0">
                              <div class="card-header bg-gradient-red text-white text-center">Reset Password</div>
                              <div class="card-body">
                                 ...
                                 @endif
                                 <form action="{{ route('forget.password.post') }}" method="POST" autocomplete="off" style="color:black" >
                                    @csrf
